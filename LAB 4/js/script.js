            ...
            <div class="card mb-3" style="background-color: ${randomColor};">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <button class="btn btn-secondary burn" data-title="${note.title}">
                            <svg
...
function postHandler(event) {
  ...
  cards.push({ title: `${card.value}`, content: `${cardContent.value}` });
...
stickyNotes.addEventListener("click", function (event) {
  ...
  const title = burnButton.dataset.title;
  cards = cards.filter((note) => note.title !== title);
  print();
});

// ================================================================================================
// version 2.0
// does not contain model updating
// ===================================================================================================
...
//notes:
//this version does not change model, only the view
